...
export default class NavBar extends Component {
  ...
  componentDidMount() {
    ...
    const nav_light_layout = document.querySelector(".nav_light_layout");
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="nav_light_layout fixed_asset">
